...
public class ProductService
{
    ...
    {
        new Product { Id=1,  Name="Diamond Solitaire Ring",     Material="18K White Gold & 1.2ct Diamond",    Price=3850, Badge="new",        Category="rings",     Stars=5, Variant="Size 7 · White Gold", StockLevel=5,
            ImageUrl="https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600&q=80",
            Images=new(){"https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=900&q=90","https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=900&q=90","https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=900&q=90","https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=900&q=90","https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=900&q=90"},
        ...
        new Product { Id=2,  Name="Sapphire Pendant Necklace", Material="18K Gold & Ceylon Sapphire",         Price=2240, OldPrice=2800, Badge="sale", Category="necklaces", Stars=5, Variant="45cm · Yellow Gold", StockLevel=3,
        ...
        new Product { Id=3,  Name="Diamond Drop Earrings",     Material="18K Rose Gold & Pavé Diamonds",      Price=1680, Badge=null,         Category="earrings",  Stars=4, Variant="Drop · Rose Gold", StockLevel=8,
        ...
        new Product { Id=4,  Name="Eternity Diamond Band",     Material="18K Gold & Full Pavé Diamonds",      Price=4200, Badge="new",        Category="rings",     Stars=5, Variant="Size 6 · Yellow Gold", StockLevel=2,
            ImageUrl="https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600&q=80",
            Images=new(){"https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=900&q=90","https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=900&q=90","https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=900&q=90","https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=900&q=90","https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=900&q=90"},
            Description="A full eternity band with pavé-set diamonds all the way around. The symbol of endless love." },

        new Product { Id=5,  Name="Gold Bangle Bracelet",      Material="Solid 18K Yellow Gold",              Price=1950, Badge=null,         Category="bracelets", Stars=5, Variant="16cm · Yellow Gold", StockLevel=4,
            ImageUrl="https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=600&q=80",
            Images=new(){"https://images.unsplash.com/photo-1611085583191-a3b181a88401?w=900&q=90","https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=900&q=90","https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=900&q=90","https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=900&q=90","https://images.unsplash.com/photo-1608042314453-ae338d9c6ad1?w=900&q=90"},
            Description="Solid 18K yellow gold bangle with a polished finish. Timeless elegance that pairs beautifully with any look." },

        new Product { Id=6,  Name="Sapphire Cocktail Ring",    Material="18K White Gold & Ceylon Sapphire",   Price=5600, Badge="bestseller", Category="rings",     Stars=5, Variant="Size 7 · White Gold", StockLevel=1,
            ImageUrl="https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=600&q=80",
            Images=new(){"https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=900&q=90","https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=900&q=90","https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=900&q=90","https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=900&q=90","https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=900&q=90"},
        ...
        new Product { Id=7,  Name="Pearl Drop Earrings",       Material="18K Gold & South Sea Pearls",        Price=890,  OldPrice=1100, Badge="sale", Category="earrings",  Stars=4, Variant="Stud · Yellow Gold", StockLevel=6,
        ...
        new Product { Id=8,  Name="Diamond Tennis Necklace",   Material="18K White Gold & Diamond Chain",     Price=6800, Badge="new",        Category="necklaces", Stars=5, Variant="42cm · White Gold", StockLevel=2,
        ...
        new Product { Id=9,  Name="Ruby Cluster Ring",         Material="18K Rose Gold & Ruby Diamonds",      Price=3200, OldPrice=3900, Badge="sale", Category="rings",     Stars=5, Variant="Size 6 · Rose Gold", StockLevel=3,
            ImageUrl="https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=600&q=80",
            Images=new(){"https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=900&q=90","https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=900&q=90","https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=900&q=90","https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=900&q=90","https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?w=900&q=90"},
            Description="A stunning cluster of rubies and diamonds in 18K rose gold. Bold, beautiful, and utterly unique." },

        new Product { Id=10, Name="Diamond Charm Bracelet",    Material="18K Gold & Diamond Charms",          Price=2750, Badge="new",        Category="bracelets", Stars=5, Variant="17cm · Yellow Gold", StockLevel=5,
        ...
        new Product { Id=11, Name="Emerald Statement Necklace",Material="18K White Gold & Colombian Emerald",  Price=8400, Badge="new",        Category="necklaces", Stars=5, Variant="40cm · White Gold", StockLevel=1,
        ...
        new Product { Id=12, Name="Akoya Pearl Stud Earrings", Material="18K Gold & Akoya Pearls",            Price=1240, Badge=null,         Category="earrings",  Stars=4, Variant="Stud · Yellow Gold", StockLevel=7,
